...
var ModCollection = Class({
	...
	_private : {
		...
		{
			if( typeof option.name !== 'string' || typeof global[option.name] !== 'function' ){
				throw new Error('mod not found');
			}

			var mod = new global[option.name]( option );
			mod.object = option.object;
